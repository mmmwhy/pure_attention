...
$System_Config['appName'] = 'this_is_sspanel_name';          //站点名称
$System_Config['baseUrl'] = 'http://this_is_sspanel_address';       //站点地址
...
// 邮件 mailgun or smtp or sendgrid
$System_Config['mailDriver'] = 'mailgun';

// 用户签到设置
$System_Config['checkinMin'] = '100';// 签到最少流量 单位MB
$System_Config['checkinMax'] = '200';// 签到最多流量 单位MB

// 用户初始流量 单位GB
$System_Config['defaultTraffic'] = '1';

// 注册后获得的邀请码数量
$System_Config['inviteNum'] = '30';
...
$System_Config['db_password'] = 'this_is_the_sspanel_database_password';
